...
export const Nocitas = () => {
  ...
  return (
    <section className='d-flex justify-content-center containerCita align-items-center'>
      <div className='text-center'>
        ...
        <button onClick={nocitasre} className="ver-btn"><strong>Agendar cita</strong></button> {/* Botón para agendar una cita con el color especificado y el texto en negrilla */}
      </div>
    </section>
  );
};
