...
const Info = () => {
  return (
    <>
      <ScrollAnimation animateIn="animate__animated animate__fadeIn" duration={0.2} animateOnce>
          ...
          <div className="cuadrados">
              <div className="cuadrado">
                  <div className="contenido-texto-cuadrado">
                      <img src="https://github.com/Condexd/_iBarber_/blob/main/ibarber/Front-end/vite-project/src/imgcar/barberia.jpg?raw=true" alt="" />
                      <p>Reserva citas sin esperas y desde cualquier lugar. Ahorra tiempo y disfruta de comodidad.</p>
                  </div>
              </div>
              <div className="cuadrado">
                  <div className="contenido-texto-cuadrado">
                      <img src="https://github.com/Condexd/_iBarber_/blob/main/ibarber/Front-end/vite-project/src/imgcar/hbarbero.jpg?raw=true" alt="" />
          ...
          <div className="contenedor">
              ...
              <div className="ventajas-cont">
                  <div className="ventaja">
                      <img src="https://github.com/Condexd/_iBarber_/blob/main/ibarber/Front-end/vite-project/src/imgcar/Tiempo.jpg?raw=true" alt="" />
                  ...
                  <div className="ventaja">
                      <img src="https://github.com/Condexd/_iBarber_/blob/main/ibarber/Front-end/vite-project/src/imgcar/peinados.jpg?raw=true" alt="" />
                  ...
                  <div className="ventaja">
                      <img src="https://github.com/Condexd/_iBarber_/blob/main/ibarber/Front-end/vite-project/src/imgcar/comodidad.png?raw=true" alt="" />
